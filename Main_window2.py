...
class Ui_Main(object):
    def setupUi(self, Main):
        ...
        self.seaarch_edit = QLineEdit(self.centralwidget)
        self.seaarch_edit.setObjectName(u"seaarch_edit")

        self.horizontalLayout_5.addWidget(self.seaarch_edit)
        ...
        self.menu = QMenu(self.menuSetting)
    ...
    def retranslateUi(self, Main):
        ...
        self.menu.setTitle(QCoreApplication.translate("Main", u"\u9009\u62e9\u4e3b\u9898", None))
